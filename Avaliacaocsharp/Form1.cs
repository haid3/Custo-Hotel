...
namespace Avaliacaocsharp
{
    public partial class Form1 : Form
    {
        ...
        {           
            ...
            {
                lbl_nome.Text = txtbox_nome.Text + " você gastou um total de: R$"+ 2*txtbox_consumo+ " no " + comboBox1.Text + ", se hospedando por " + box_dias.Text + " dia(s).";
                ...
                // utilizar o tab index//
                 if (comboBox1.TabIndex == 3)
                    {
        ...
        private void lbl_pessoas_Click(object sender, EventArgs e)
        {
            
        }

        private void lbl_dias_Click(object sender, EventArgs e)
        {
